...
import storm.jubatus.NoSuchSolverException;
import storm.jubatus.solver.Recommender;
import storm.jubatus.solver.Regression;
import storm.jubatus.solver.Solver;
 ...
 */
public class JubatusBolt extends BaseRichBolt {

    private static final Logger LOG = LoggerFactory.getLogger(JubatusBolt.class);
